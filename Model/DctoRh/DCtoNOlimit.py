...
train_test_data = train_test_data.drop(['Prd_Inst_Id.1'], axis=1)
train_test_data = train_test_data.drop(['Accs_Nbr'], axis=1)
...
clf = lgb.LGBMClassifier(
    ...
    max_depth=7, n_estimators=3000, objective='binary',
...
result.to_csv('rh_09to11dctorh_result_1bi2.csv',index=False)
...
print(result)
# result2 = result.iloc[:,0]
result.to_csv('rh_09to11dctorh_result_1bi3.csv',index=False)
